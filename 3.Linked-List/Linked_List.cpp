...
int main() {
	...
	list.push_back("Naruto");
	list.push_back("Naruto");
	list.push_back("Naruto");
	list.push_back("Minato");
	list.push_back("Minato");
	list.push_front("Itachi");
	list.insert_at(2, "Kakashi");
	std::cout << list << '\n';
	list.pop_front();
	std::cout << list << '\n';
	list.pop_back();
	...
	list[1] = "Shikamaru";
	std::cout << list[1] << '\n';
	list.push_front("Gojo");
	list.push_front("Shisui");
	list.push_front("Todo");
	list.push_front("Endou");
	std::cout << list << '\n';
	list.reverse();
	std::cout << list << '\n';
	list.reverse();
	...
	list_int.remove(99); // Will remove all ocurrences of the element
	std::cout << list_int << '\n';
